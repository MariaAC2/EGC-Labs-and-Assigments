...
void Lab4::RenderScene() {
    ...
    modelMatrix *= transform3D::Translate(centerX, centerY, centerZ);
...
void Lab4::OnKeyPress(int key, int mods)
{
    ...
    if (key == GLFW_KEY_SPACE)
    {
        ...
        miniViewportArea.y += moveRatio * 10;
    }
    else if (key == GLFW_KEY_J) {
        miniViewportArea.x -= moveRatio * 10;
    }
        ...
        float width = miniViewportArea.width;
        float height = miniViewportArea.height;

        miniViewportArea.width -= moveRatio * 10;
        miniViewportArea.height -= moveRatio * 10;

        miniViewportArea.x -= (miniViewportArea.width - width) / 2;
        miniViewportArea.y -= (miniViewportArea.height - height) / 2;
    }
        ...
        miniViewportArea.x += (width - miniViewportArea.width) / 2;
        miniViewportArea.y += (height - miniViewportArea.height) / 2;
    }
