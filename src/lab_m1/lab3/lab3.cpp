...
void Lab3::Init()
{
    ...
    sunPosX = corner.x + squareSide / 2.0f;
    sunPosY = corner.y + squareSide / 2.0f;
    ...
    Mesh* sun = object2D::CreateSquare("sun", corner, squareSide, glm::vec3(1, 0.816f, 0), true);
    AddMeshToList(sun);

    Mesh* earth = object2D::CreateSquare("earth", corner, squareSide, glm::vec3(0.024f, 0.369f, 0.051f), true);
    AddMeshToList(earth);
...
void Lab3::Update(float deltaTimeSeconds)
{
    ...
    modelMatrix = glm::mat3(1);
    modelMatrix *= transform2D::Translate(translateX, sunPosY);
    modelMatrix *= transform2D::Translate(800, 250);

    sunPosY += deltaTimeSeconds;
    ...
    modelMatrix *= transform2D::Translate(800 + cx, 250 + cy);
    modelMatrix *= transform2D::Rotate(angularStep);
