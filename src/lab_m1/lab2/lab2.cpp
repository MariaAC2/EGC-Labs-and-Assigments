...
void Lab2::Init()
{
...

    {
        ...
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.922f, 0.549f, 0.82f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(0.922f, 0.549f, 0.82f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(0.922f, 0.549f, 0.82f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5f, 1, 0.5f), glm::vec3(0.922f, 0.549f, 0.82f), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
    ...
    {
        vector<VertexFormat> vertices_t1
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(1, 0.635f, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0.635f, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 1, 0), glm::vec3(1, 0.635f, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0, 1, 0), glm::vec3(1, 0.635f, 0), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh

        };

        vector<unsigned int> indices_t1 =
        {
            0, 1, 2,    // indices for first triangle
            0, 3, 2,
            // TODO(student): Complete indices data for the cube mesh
        ...
        // Actually create the mesh from the data
        CreateMesh("triangle1", vertices_t1, indices_t1);
    }

    {
        vector<VertexFormat> vertices1
        {
            VertexFormat(glm::vec3(0, 0, 0), glm::vec3(0.922f, 0.549f, 0.82f), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(1, 0, 0), glm::vec3(1, 0.635f, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5f, 0, 1), glm::vec3(0.914f, 1, 0), glm::vec3(0.2, 0.8, 0.6)),
            VertexFormat(glm::vec3(0.5f, 1, 0.5f), glm::vec3(0.922f, 0.549f, 0.82f), glm::vec3(0.2, 0.8, 0.6)),
            // TODO(student): Complete the vertices data for the cube mesh
        ...
        // Actually create the mesh from the data
        CreateMesh("tetrahedron_colored", vertices1, indices1);
    }
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    //RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(0.5f, 2, 0), glm::vec3(0.75f));

    // TODO(student): Draw the tetrahedron
    //RenderMesh(meshes["tetrahedron"], shaders["VertexColor"], glm::vec3(1, 1, 0), glm::vec3(0.75f));

    RenderMesh(meshes["triangle1"], shaders["VertexColor"], glm::vec3(2, 2, 0), glm::vec3(0.5f));
